...
<span class=fifth><a href=profile_view.php><span class=iner>profile</span></a></span>
<span class=fifth><?php echo'<a href=profile_view.php?update='.$_SESSION['roll'].'>';?> <span class=iner>update</span></a></span>
<span class=fifth><?php echo'<a href=identity_view.php?id='.$_SESSION['roll'].'>';?> <span class=iner>identity card</span></a></span>
<span class=fifth><a href=log_out.php ><span class=iner>logout</span></a></span>
...
{echo'<div id=dv>';
	echo'<form action=profile_view.php method=post enctype=multipart/form-data >';
...
{
	echo'<br><br><span id=ud28>identification :<textarea id=updt28 name=name30 cols=15 rows=2 ></textarea></span>';

}
if(isset($_POST['checkbox30']))
{echo'<div id=dv8><br><br>PHOTO DETAILS</div>';
	echo'<br><br><span id=ud29>PROFILE PICTURE :<input type=file id=updt29 name=photo1 ></span>';
...
{header('location:profile_view.php');
	...
	||$connect30==true||$connect31==true||$connect32==true||$connect33==true||$connect34==true||$connect35==true||$connect36==true
||$connect37==true||$connect38==true||$connect39==true||$connect40==true||$connect41==true||$connect42==true)
	{header('location:profile_view.php');
	}else{echo'no';}
	}

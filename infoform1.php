...
padding:0px;
margin:0px;
background-image: url(high-quality-x-hd-experiment-widescreen-amnay-technology_hd-experiment-widescreen-amnay-technology.jpg);
...
<body id='main' onLoad="MM_preloadImages('../../../../ddd.png')">
...
"<?php }?>";
  ...
  <div id="apDiv1">
  <div id="header">
  <div id="header1">STUDENT INFORMATION SYSTEM</div>
  
  <div id="apDiv3"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../../../ddd.png',1)"><img src="ddd.png" width="213" height="115" id="Image1"></a></div>
  <div id="apDiv4"><a href="user_home_main.php"><img src="home_button.png" width="202" height="49"></a></div>
  </div>
